...
export const MOCK_PROMPTS: Prompt[] = [
  ...
  // --- NOVOS PROMPTS (61-90) - Estilo Premium / Arnold Alvaro Inspired ---
  {
    id: "61",
    title: "Retrato Ethereal Glow",
    description: "Fotografia de retrato com iluminação bioluminescente suave.",
    prompt_text: "Hyperrealistic portrait of a celestial woman with translucent skin, glowing bioluminescent veins, soft ethereal lighting, shot on 85mm lens, f/1.8, cinematic depth of field, 8k resolution.",
    category: Category.PHOTOGRAPHY,
    difficulty: Difficulty.ADVANCED,
    image_url: "https://image.pollinations.ai/prompt/celestial%20woman%20portrait,%20bioluminescent%20skin,%20ethereal%20glow,%20hyperrealistic%20photography?width=1024&height=576&nologo=true&seed=61",
    created_date: "2024-05-01"
  },
  {
    id: "62",
    title: "Alta Costura Futurista: Vidro",
    description: "Moda conceitual feita de materiais impossíveis.",
    prompt_text: "Avant-garde fashion editorial, model wearing a dress made entirely of liquid glass and fiber optics, refracting light, studio setting with dark background, high fashion pose, vogue style.",
    category: Category.PHOTOGRAPHY,
    difficulty: Difficulty.ADVANCED,
    image_url: "https://image.pollinations.ai/prompt/avant-garde%20fashion%20model,%20liquid%20glass%20dress,%20fiber%20optics,%20vogue%20editorial,%20studio?width=1024&height=576&nologo=true&seed=62",
    created_date: "2024-05-02"
  },
  {
    id: "63",
    title: "Arquitetura Paramétrica Musgo",
    description: "Fusão de arquitetura brutalista e natureza.",
    prompt_text: "Futuristic parametric architecture building facade covered in lush moss and vertical gardens, concrete and glass texture, soft overcast lighting, architectural visualization, unreal engine 5.",
    category: Category.IMAGE_GENERATION,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/parametric%20architecture%20building,%20brutalist%20concrete,%20moss%20vertical%20garden,%20unreal%20engine%205?width=1024&height=576&nologo=true&seed=63",
    created_date: "2024-05-03"
  },
  {
    id: "64",
    title: "Samurai Cyberpunk Ouro",
    description: "Guerreiro futurista com armadura detalhada.",
    prompt_text: "Cyberpunk samurai standing in rain, black and gold ornate armor, glowing katana, neon city background bokeh, wet surfaces reflection, cinematic composition, highly detailed.",
    category: Category.CHARACTER_CONSISTENCY,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/cyberpunk%20samurai%20gold%20armor,%20neon%20rain,%20glowing%20katana,%20cinematic%20composition?width=1024&height=576&nologo=true&seed=64",
    created_date: "2024-05-04"
  },
  {
    id: "65",
    title: "Retrato de Idoso Galáctico",
    description: "Rosto com texturas extremas e olhos cósmicos.",
    prompt_text: "Close-up portrait of an elderly man with galaxies reflecting in his eyes, extreme skin texture detail, wrinkles, dramatic side lighting, cosmic atmosphere, hyperrealism.",
    category: Category.PHOTOGRAPHY,
    difficulty: Difficulty.ADVANCED,
    image_url: "https://image.pollinations.ai/prompt/elderly%20man%20portrait,%20galaxy%20eyes,%20extreme%20details,%20wrinkles,%20cosmic%20lighting?width=1024&height=576&nologo=true&seed=65",
    created_date: "2024-05-05"
  },
  {
    id: "66",
    title: "Smartphone Transparente Conceito",
    description: "Design de produto futurista minimalista.",
    prompt_text: "Futuristic transparent smartphone concept art, floating in mid-air, holographic interface display, sleek glass design, product render, clean studio lighting.",
    category: Category.PRODUCT_DESIGN,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/transparent%20smartphone%20concept,%20holographic%20ui,%20floating,%20product%20design%20render?width=1024&height=576&nologo=true&seed=66",
    created_date: "2024-05-06"
  },
  {
    id: "67",
    title: "Deusa Dourada Egípcia",
    description: "Fantasia histórica com toque sci-fi.",
    prompt_text: "Egyptian goddess with metallic gold skin, wearing futuristic cybernetic jewelry, dramatic eyeliner, dark temple background, cinematic lighting, octane render.",
    category: Category.DIGITAL_ART,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/egyptian%20goddess%20gold%20skin,%20cybernetic%20jewelry,%20cinematic,%20octane%20render?width=1024&height=576&nologo=true&seed=67",
    created_date: "2024-05-07"
  },
  {
    id: "68",
    title: "Microchip Biológico",
    description: "Macro fotografia de tecnologia orgânica.",
    prompt_text: "Macro shot of a biological computer chip, mixing green plant cells with copper circuits, moist texture, depth of field, scientific visualization.",
    category: Category.PRODUCT_DESIGN,
    difficulty: Difficulty.ADVANCED,
    image_url: "https://image.pollinations.ai/prompt/biological%20computer%20chip,%20plant%20cells%20circuits,%20macro%20photography,%20moist%20texture?width=1024&height=576&nologo=true&seed=68",
    created_date: "2024-05-08"
  },
  {
    id: "69",
    title: "Floresta de Cristal",
    description: "Paisagem de fantasia com materiais refrativos.",
    prompt_text: "Fantasy landscape of a forest made entirely of prism crystals, rainbow light refraction, misty atmosphere, magical vibe, 3d render.",
    category: Category.IMAGE_GENERATION,
    difficulty: Difficulty.BEGINNER,
    image_url: "https://image.pollinations.ai/prompt/crystal%20forest%20landscape,%20prism%20refraction,%20rainbow%20light,%20magical,%203d%20render?width=1024&height=576&nologo=true&seed=69",
    created_date: "2024-05-09"
  },
  {
    id: "70",
    title: "Tênis de Lava Derretida",
    description: "Conceito de tênis com texturas extremas.",
    prompt_text: "Sneaker design made of cooling volcanic lava, glowing red cracks, obsidian black sole, smoke effects, dramatic product photography.",
    category: Category.PRODUCT_DESIGN,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/lava%20sneaker%20design,%20magma%20texture,%20glowing%20cracks,%20smoke,%20product%20photo?width=1024&height=576&nologo=true&seed=70",
    created_date: "2024-05-10"
  },
  {
    id: "71",
    title: "Astronauta Floral",
    description: "Surrealismo misturando sci-fi e natureza.",
    prompt_text: "Astronaut helmet filled with blooming colorful flowers instead of a face, reflections on visor, space background, surreal art style, detailed.",
    category: Category.ARTISTIC_EFFECTS,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/astronaut%20helmet%20filled%20with%20flowers,%20surreal%20art,%20space%20background,%20detailed?width=1024&height=576&nologo=true&seed=71",
    created_date: "2024-05-11"
  },
  {
    id: "72",
    title: "Escultura de Água em Movimento",
    description: "Congelamento de movimento líquido formando um rosto.",
    prompt_text: "High speed photography of splashing water forming a human face profile, crystal clear liquid, blue gradient background, studio lighting.",
    category: Category.PHOTOGRAPHY,
    difficulty: Difficulty.ADVANCED,
    image_url: "https://image.pollinations.ai/prompt/water%20splash%20sculpture%20human%20face,%20high%20speed%20photography,%20liquid%20art?width=1024&height=576&nologo=true&seed=72",
    created_date: "2024-05-12"
  },
  {
    id: "73",
    title: "Cyber-Gótico Vitoriano",
    description: "Fusão de estilos históricos e futuristas.",
    prompt_text: "Victorian gothic woman wearing gas mask with neon tubes, lace dress with cybernetic implants, dark moody atmosphere, rain, cinematic shot.",
    category: Category.CHARACTER_CONSISTENCY,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/victorian%20gothic%20cyberpunk%20woman,%20gas%20mask,%20neon,%20dark%20moody,%20cinematic?width=1024&height=576&nologo=true&seed=73",
    created_date: "2024-05-13"
  },
  {
    id: "74",
    title: "Interior de Carro de Luxo 2050",
    description: "Design automotivo futurista e elegante.",
    prompt_text: "Interior view of a luxury autonomous car from year 2050, white leather, wood accents, holographic dashboard, view of futuristic city outside window.",
    category: Category.IMAGE_GENERATION,
    difficulty: Difficulty.BEGINNER,
    image_url: "https://image.pollinations.ai/prompt/luxury%20future%20car%20interior%202050,%20white%20leather,%20hologram,%20city%20view?width=1024&height=576&nologo=true&seed=74",
    created_date: "2024-05-14"
  },
  {
    id: "75",
    title: "Retrato Dupla Exposição: Cidade",
    description: "Silhueta humana preenchida com arquitetura.",
    prompt_text: "Double exposure portrait of a man's side profile containing a busy new york street scene, yellow taxis, skyscrapers, monochrome with selective color.",
    category: Category.ARTISTIC_EFFECTS,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/double%20exposure%20man%20profile%20city%20street,%20skyscrapers,%20artistic%20photography?width=1024&height=576&nologo=true&seed=75",
    created_date: "2024-05-15"
  },
  {
    id: "76",
    title: "Cerâmica Kintsugi Brilhante",
    description: "Arte japonesa com reparos em ouro brilhante.",
    prompt_text: "Black matte ceramic bowl repaired with glowing molten gold (kintsugi), dark background, smoke, dramatic lighting, macro shot.",
    category: Category.PRODUCT_DESIGN,
    difficulty: Difficulty.BEGINNER,
    image_url: "https://image.pollinations.ai/prompt/kintsugi%20black%20bowl%20glowing%20gold,%20macro%20photography,%20dramatic%20lighting?width=1024&height=576&nologo=true&seed=76",
    created_date: "2024-05-16"
  },
  {
    id: "77",
    title: "Retrato Afro-Futurista",
    description: "Estilo vibrante e cultural com tecnologia.",
    prompt_text: "Afrofuturist portrait of a queen, vibrant traditional patterns mixed with metallic sci-fi armor, golden jewelry, confident gaze, epic lighting.",
    category: Category.DIGITAL_ART,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/afrofuturist%20queen%20portrait,%20sci-fi%20armor,%20vibrant%20patterns,%20gold,%20epic?width=1024&height=576&nologo=true&seed=77",
    created_date: "2024-05-17"
  },
  {
    id: "78",
    title: "Mundo Miniatura em Garrafa",
    description: "Cena detalhada dentro de um objeto de vidro.",
    prompt_text: "A tiny magical island with a lighthouse inside a vintage glass bottle, floating on the sea, realistic water texture, sunset lighting, macro.",
    category: Category.IMAGE_GENERATION,
    difficulty: Difficulty.BEGINNER,
    image_url: "https://image.pollinations.ai/prompt/island%20inside%20glass%20bottle,%20lighthouse,%20miniature%20world,%20realistic,%20sunset?width=1024&height=576&nologo=true&seed=78",
    created_date: "2024-05-18"
  },
  {
    id: "79",
    title: "Explosão de Tinta em Pó",
    description: "Movimento congelado de cores vibrantes.",
    prompt_text: "Explosion of holi powder colors (pink, blue, yellow) forming the shape of a lion head, black background, high contrast, artistic photography.",
    category: Category.ARTISTIC_EFFECTS,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/holi%20powder%20explosion%20lion%20head,%20vibrant%20colors,%20black%20background,%20artistic?width=1024&height=576&nologo=true&seed=79",
    created_date: "2024-05-19"
  },
  {
    id: "80",
    title: "Robô Vintage de Madeira",
    description: "Design de personagem com texturas naturais.",
    prompt_text: "Friendly robot made of polished mahogany wood and brass gears, steampunk influences, soft warm lighting, standing on a desk, depth of field.",
    category: Category.CHARACTER_CONSISTENCY,
    difficulty: Difficulty.BEGINNER,
    image_url: "https://image.pollinations.ai/prompt/wooden%20robot%20mahogany%20brass,%20steampunk%20toy,%20macro%20photography,%20warm%20light?width=1024&height=576&nologo=true&seed=80",
    created_date: "2024-05-20"
  },
  {
    id: "81",
    title: "Cozinha Cyberpunk",
    description: "Ambiente doméstico futurista e detalhado.",
    prompt_text: "Cyberpunk apartment kitchen, neon ramen noodles, holographic recipes, cluttered but cozy, rainy window view, blade runner aesthetic.",
    category: Category.IMAGE_GENERATION,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/cyberpunk%20kitchen%20interior,%20neon%20lights,%20ramen,%20cluttered%20cozy,%20futuristic?width=1024&height=576&nologo=true&seed=81",
    created_date: "2024-05-21"
  },
  {
    id: "82",
    title: "Retrato Subaquático Fashion",
    description: "Fotografia de moda embaixo d'água.",
    prompt_text: "Underwater fashion photography, woman in long flowing red dress, weightless hair, light rays piercing water surface, serene expression, ethereal.",
    category: Category.PHOTOGRAPHY,
    difficulty: Difficulty.ADVANCED,
    image_url: "https://image.pollinations.ai/prompt/underwater%20fashion%20photography,%20red%20dress%20flowing,%20light%20rays,%20ethereal?width=1024&height=576&nologo=true&seed=82",
    created_date: "2024-05-22"
  },
  {
    id: "83",
    title: "Jóia Inseto Mecânico",
    description: "Design de produto complexo e luxuoso.",
    prompt_text: "Mechanical beetle brooch jewelry, made of gold, rubies and clockwork gears, white background, soft shadow, luxury product shot.",
    category: Category.PRODUCT_DESIGN,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/mechanical%20beetle%20jewelry%20brooch,%20gold%20rubies%20gears,%20luxury%20product?width=1024&height=576&nologo=true&seed=83",
    created_date: "2024-05-23"
  },
  {
    id: "84",
    title: "Paisagem de Papelão",
    description: "Arte criativa usando materiais simples.",
    prompt_text: "Diorama landscape made entirely of cardboard cutouts, mountains and trees, warm lighting simulating sunset, tilt-shift effect, craft style.",
    category: Category.ARTISTIC_EFFECTS,
    difficulty: Difficulty.BEGINNER,
    image_url: "https://image.pollinations.ai/prompt/cardboard%20diorama%20landscape,%20craft%20art,%20warm%20lighting,%20tilt-shift,%20creative?width=1024&height=576&nologo=true&seed=84",
    created_date: "2024-05-24"
  },
  {
    id: "85",
    title: "Neon Demon Portrait",
    description: "Estilo de filme de terror neon.",
    prompt_text: "Portrait of a woman with neon paint on face, glowing under UV light, intense gaze, dark background, purple and blue palette, cinematic horror.",
    category: Category.PHOTOGRAPHY,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/neon%20face%20paint%20portrait,%20uv%20light,%20purple%20blue,%20cinematic%20horror%20style?width=1024&height=576&nologo=true&seed=85",
    created_date: "2024-05-25"
  },
  {
    id: "86",
    title: "Carro Esportivo Transparente",
    description: "Veículo conceito com chassi de vidro.",
    prompt_text: "Futuristic sports car with transparent glass chassis showing internal engine mechanics, racing on a neon track, motion blur, hyperrealistic.",
    category: Category.PRODUCT_DESIGN,
    difficulty: Difficulty.ADVANCED,
    image_url: "https://image.pollinations.ai/prompt/transparent%20glass%20sports%20car,%20visible%20engine,%20neon%20track,%20motion%20blur?width=1024&height=576&nologo=true&seed=86",
    created_date: "2024-05-26"
  },
  {
    id: "87",
    title: "Biblioteca Infinita",
    description: "Cenário surreal de conhecimento.",
    prompt_text: "Infinite library with floating books, spiral staircases going up forever, magical dust motes, warm candle lighting, fantasy atmosphere.",
    category: Category.IMAGE_GENERATION,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/infinite%20fantasy%20library,%20floating%20books,%20spiral%20stairs,%20magical%20atmosphere?width=1024&height=576&nologo=true&seed=87",
    created_date: "2024-05-27"
  },
  {
    id: "88",
    title: "Retrato em Fios de Cobre",
    description: "Arte escultural usando metal.",
    prompt_text: "Portrait of a face formed by thousands of tangled copper wires, metallic texture, studio lighting highlighting the edges, abstract art sculpture.",
    category: Category.ARTISTIC_EFFECTS,
    difficulty: Difficulty.ADVANCED,
    image_url: "https://image.pollinations.ai/prompt/copper%20wire%20sculpture%20face,%20metallic%20art,%20studio%20lighting,%20abstract?width=1024&height=576&nologo=true&seed=88",
    created_date: "2024-05-28"
  },
  {
    id: "89",
    title: "Gato Samurai",
    description: "Animal antropomórfico em traje histórico.",
    prompt_text: "Anthropomorphic cat dressed as a samurai warrior, holding a katana, cherry blossom background, cinematic lighting, highly detailed fur.",
    category: Category.CHARACTER_CONSISTENCY,
    difficulty: Difficulty.BEGINNER,
    image_url: "https://image.pollinations.ai/prompt/cat%20samurai%20warrior,%20detailed%20armor,%20cherry%20blossom,%20cinematic%20lighting?width=1024&height=576&nologo=true&seed=89",
    created_date: "2024-05-29"
  },
  {
    id: "90",
    title: "Fones de Ouvido Levitando",
    description: "Fotografia de produto high-tech.",
    prompt_text: "Wireless headphones levitating in a sound wave visualization, neon particles, dark background, sleek modern design, product advertisement.",
    category: Category.PRODUCT_DESIGN,
    difficulty: Difficulty.INTERMEDIATE,
    image_url: "https://image.pollinations.ai/prompt/levitating%20headphones%20product,%20sound%20wave%20particles,%20neon,%20high%20tech?width=1024&height=576&nologo=true&seed=90",
